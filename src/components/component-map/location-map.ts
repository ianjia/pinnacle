...
export const locationMap: Map<string, LocationURLCombined> = new Map([
    ...
    ["UC Berkeley", { loc: { latitude: 37.8719, longitude: -122.2585 }, url: new URL("https://www.berkeley.edu/") }],
    ...
    ["UCLA", { loc: { latitude: 34.0689, longitude: -118.4452 }, url: new URL("https://www.ucla.edu/") }],
    ...
    ["UC Santa Barbara", { loc: { latitude: 34.4139, longitude: -119.8489 }, url: new URL("https://www.ucsb.edu/") }],
    ...
    ["UC San Diego", { loc: { latitude: 32.8801, longitude: -117.2340 }, url: new URL("https://www.ucsd.edu/") }],
    ["University of California, Irvine", { loc: { latitude: 33.6405, longitude: -117.8443 }, url: new URL("https://www.uci.edu/") }],
    ["UC Irvine", { loc: { latitude: 33.6405, longitude: -117.8443 }, url: new URL("https://www.uci.edu/") }],
